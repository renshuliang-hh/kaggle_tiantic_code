...
combine_df['Fare_1']=combine_df['Fare_(8.662, 26.0]']
combine_df['Fare_2']=combine_df['Fare_(26.0, 512.329]']
combine_df = combine_df.drop('Fare_(8.662, 26.0]',axis=1)
combine_df = combine_df.drop('Fare_(26.0, 512.329]',axis=1)
